...
-- Started on 2022-08-05 15:51:28
...
COPY public.products (id, name_product, price, conditon, photo, description, rating, seller_id) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.profile_store_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.users_seller_id_seq', 2, true);
...
-- Completed on 2022-08-05 15:51:28
